(function ($) {
  ...
  //Chat Popup - handled by React component
  ...
  $(document).ready(function () {
    function dynamicCurrentMenuClass(selector) {
      ...
      selector.find("a").each(function () {
        ...
        // Normalize URL
        try {
          let url = new URL(linkPath, window.location.origin);
        ...
        if (linkPath === currentPath || linkPath === currentPath + "/") {
          // Add .current to the closest li and parent dropdown li
          $(this).closest("li").addClass("current");
          $(this).closest("li").parents("li.dropdown").addClass("current");
        }
